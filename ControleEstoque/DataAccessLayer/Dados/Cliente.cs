...
namespace Dados
{
    public static class Cliente
    {
        ...
        public static void Inserir(ref Entidades.Cliente unidade)
        {
        ...
        public static void Alterar(ref Entidades.Cliente unidade)
        {
            if (s_comandoAlterar == null)
            {
                ...
                s_comandoAlterar.CommandText = @"UPDATE Clientes 
                                                 SET Tipo = @tipo, Nome = @nome, RazaoSocial = @razaoSocial, Cpf = @cpf, Cnpj = @cnpj, Logradouro = @logradouro, Numero = @numero, Complemento = @complemento, Bairro = @bairro, Cidade = @cidade, Estado = @estado, Inativo = @inativo
                                                 WHERE Codigo = @codigo";
